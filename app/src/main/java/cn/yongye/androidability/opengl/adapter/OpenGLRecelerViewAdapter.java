package cn.yongye.androidability.opengl.adapter;
...
public class OpenGLRecelerViewAdapter extends RecyclerView.Adapter<OpenGLRecelerViewAdapter.ViewHolder> {

    private static final String TAG = OpenGLRecelerViewAdapter.class.getSimpleName();
    public LinkedHashMap<Integer, String> mData;
    LayoutInflater mInflater;


    public OpenGLRecelerViewAdapter(Context context, LinkedHashMap<Integer, String> data) {
        this.mData = data;
    ...
    @NonNull
    @Override
    public OpenGLRecelerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_demo_recyclerview, parent, false);
        return new OpenGLRecelerViewAdapter.ViewHolder(view);
    }
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull OpenGLRecelerViewAdapter.ViewHolder holder, int position) {
